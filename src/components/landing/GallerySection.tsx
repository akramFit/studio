    ...
    <section id="gallery" className="py-20 md:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-headline font-bold text-foreground">Gallery</h2>
          <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">A showcase of my personal journey and dedication to the sport.</p>
        </div>
